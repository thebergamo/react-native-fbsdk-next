...
function getMergePropsWithConfig(config, props) {
    const facebookConfig = config.plugins?.facebook || {};
    const { appId: facebookAppId, displayName: facebookDisplayName, scheme: facebookScheme, autoInitEnabled: facebookAutoInitEnabled, autoLogAppEventsEnabled: facebookAutoLogAppEventsEnabled, advertiserIDCollectionEnabled: facebookAdvertiserIDCollectionEnabled, } = facebookConfig;
